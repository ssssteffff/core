OC.L10N.register(
    ...
    "_You have %n app update pending_::_You have %n app updates pending_" : ["Vous avez %n application qui attend sa mise à jour .","Vous avez %n applications qui attendent leurs mises à jour ."],
